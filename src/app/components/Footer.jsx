...
export default function Footer() {
    ...
    return (
        <footer className="bg-[#FAFAFA] mx-[10px] mb-[10px] px-8 md:px-16 pt-20 pb-0 flex flex-col mt-20 text-zinc-900 border border-zinc-200 rounded-[2rem]">
            <div className="max-w-7xl mx-auto w-full flex flex-col md:flex-row justify-between gap-16 md:gap-8">
                ...
                <div className="max-w-xs md:max-w-sm flex flex-col">
                    <div className="flex items-center gap-3 mb-6 relative w-max">
                        ...
                        <div className="absolute -top-3 -right-8 bg-white border border-zinc-100 shadow-sm rounded-xl p-1 flex items-center justify-center">
                    ...
                    <div className="flex items-center gap-4">
                        {[FaInstagram, FaXTwitter, FaLinkedinIn, FaDribbble].map((Icon, idx) => (
                            <a
                                key={idx}
                                href="#"
                                className="w-12 h-12 bg-white rounded-full flex items-center justify-center shadow-sm border border-zinc-100 text-zinc-600 hover:text-black hover:scale-105 hover:shadow-md transition-all duration-300"
                            >
                ...
                <div className="flex flex-col sm:flex-row gap-16 md:gap-32 md:pl-20">
                    ...
                    <div className="flex flex-col gap-4">
                        <h3 className="font-semibold text-zinc-900 text-[15px] mb-2 tracking-tight">Services</h3>
                    ...
                    {/* Column 2: Portfolios */}
                    <div className="flex flex-col gap-4">
                        <h3 className="font-semibold text-zinc-900 text-[15px] mb-2 tracking-tight">Portfolios</h3>
                        <a href="#" className="font-medium text-zinc-500 hover:text-zinc-900 text-sm transition-colors flex items-center gap-3 w-max group">
                            <FaCamera size={14} className="text-zinc-400 group-hover:text-black transition-colors" />
                            Weddings
                        </a>
                    ...
                    <div className="flex flex-col gap-4">
                        <h3 className="font-semibold text-zinc-900 text-[15px] mb-2 tracking-tight">Privacy & Policy</h3>
            ...
            <div className="w-full mt-16 py-6 border-t border-zinc-200 flex flex-col md:flex-row items-center justify-between gap-2">
