...
function DynamicTag({ text }) {
    return (
        <motion.div
            ...
            className="absolute left-[13%] md:left-[20%] -top-[90%] min-w-[120px] flex px-5 py-2 bg-black backdrop-blur-md  text-white rounded-full items-center justify-center shadow-xl cursor-pointer z-50"
        >
                    ...
                    <motion.div style={{ y: cardY }}>
                        <div className="relative w-full h-[65vh] rounded-[1.5rem] overflow-hidden shadow-[0_40px_80px_-20px_rgba(0,0,0,0.4)] bg-zinc-950">
                            ...
                            <div className="absolute inset-0 z-20 pointer-events-none">
                                ...
                                <div className="absolute left-6 right-6 bottom-4 md:left-10 md:right-10 md:bottom-8 flex items-end justify-between pointer-events-auto">
                                    <div className="space-y-4 max-w-sm">
                                        <AnimatePresence mode="wait">
                                            {/* Dynamic tag that animates in sync with the current slide */}
                                            <DynamicTag text={photoData[currentIndex].place} key={`tag-${currentIndex}`} />
