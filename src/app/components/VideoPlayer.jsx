        ...
        <>
            ...
            <section id="video-showcase" ref={sectionRef} className="relative min-h-screen w-full overflow-hidden" style={{ fontFamily: "'DM Sans', sans-serif" }}>
                ...
                <div className="w-full flex flex-col items-center justify-center min-h-screen relative z-10">
                    ...
                    <div className="w-full max-w-6xl mx-auto absolute top-12 md:top-24 px-5 md:px-0 z-30 pointer-events-none">
                        ...
                        <div className="mb-6 flex flex-col items-start gap-3">
                            <motion.span
                                ...
                                className="text-xs font-semibold uppercase tracking-widest text-orange-500"
                            >
                                {/* — Masterpiece */}
                            </motion.span>
                    ...
                    <div className="w-full max-w-[1360px]  mx-auto flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-20 z-20 px-5 md:px-10">
                        ...
                        <div className="flex flex-col gap-8 w-full lg:w-[40%] max-w-[500px] z-10">
                            <div className="space-y-4">
                                ...
                                <h2 className="text-5xl font-black tracking-[-0.01em] text-gray-900 leading-[0.9]">
                                    Cinematic <br /> <span className="text-orange-500">Language.</span>
                                </h2>
                            ...
                            <div className="flex flex-col gap-6">
                                ...
                                <div className="grid grid-cols-1 gap-6">
                                    <div className="flex items-start gap-4 group">
                                        <div className="p-3.5 bg-gray-50 rounded-2xl text-orange-500 group-hover:bg-orange-500 group-hover:text-white transition-all duration-300 shadow-sm group-hover:shadow-orange-200">
                            ...
                            <button
                                ...
                                className="btn-primary w-fit flex items-center gap-4 group  px-10 py-5 h-16 text-[11px] font-black uppercase tracking-widest shadow-2xl hover:shadow-orange-500/20 bg-orange-500 text-white rounded-full"
                            >
                        ...
                        <motion.div
                            ...
                            className="relative h-[70vh] w-full lg:w-[70%] overflow-hidden bg-black shadow-[0_50px_100px_-20px_rgba(0,0,0,0.3)] border border-gray-100 group z-20"
                        >
                            <video
                                ref={videoRef}
                            ...
                            <div className="absolute top-0 inset-x-0 h-16 bg-linear-to-b from-black/80 to-transparent z-40 flex items-start pt-4 justify-between px-6 pointer-events-none">
                                ...
                                {/* Title */}
                                <div className="text-white/90 text-[10px] mt-0.5 font-bold line-clamp-1 tracking-[0.2em] uppercase">
                                    Waguri AND Rintaro..
                                </div>
                                    ...
                                    >
                                        ...
                                        >
                                            <div className="flex items-center justify-between mb-4 pb-3 border-b border-white/10 shrink-0">
                                                ...
                                                <button onClick={() => setShowInfo(false)} className="text-white/50 hover:text-orange-500 transition-colors">
                                                    <FaXmark size={16} />
                                                </button>
                                            </div>
                                            ...
                                            <div className="space-y-4 flex-1 min-h-0 text-[11px] text-white/70 overflow-y-auto custom-scrollbar pr-2 pb-2 pointer-events-auto">
                                                <div>
                                                    <h4 className="text-orange-500/80 text-[10px] uppercase font-black tracking-widest mb-1">Duration</h4>
                            ...
                            <div className="absolute bottom-5 w-[95%] max-w-[500px] left-1/2 -translate-x-1/2 z-40 opacity-0 group-hover:opacity-100 transition-all duration-300">
                                <div className="flex items-center justify-between gap-4 bg-white/10 backdrop-blur-xl p-4 px-6 rounded-[40px] border border-white/20 shadow-2xl w-full">
                                    ...
                                    <div className="flex items-center gap-4">
                                        <button onClick={togglePlay} className="text-white border-2 border-white/10 px-2 py-2 rounded-full hover:text-orange-500 transition-transform active:scale-90 shrink-0">
                                    ...
                                    <div className="flex items-center gap-4 border-l border-white/20 pl-4 shrink-0">
                                        <button onClick={toggleMute} className="text-white/80 hover:text-orange-500 transition-colors">
