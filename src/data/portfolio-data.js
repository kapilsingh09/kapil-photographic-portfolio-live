...
export const portfolioData = {
  ...
  hero: {
    ...
    images: [
      ...
      { id: 3, src: "/images/img-3.jpeg", tag: "@robin", color: "bg-violet-600" },
      { id: 4, src: "/images/img-4.jpeg", tag: "@taylor", color: "bg-amber-500" },
      { id: 7, src: "/images/img-cat.jpg", tag: "@alex", color: "bg-cyan-500" },
  ...
  anthology: {
    ...
    items: [
      { id: 1, place: "@tokyo", info: "Neon reflections across the bustling Shibuya crossing under a midnight drizzle.", src: "/photocard_imgs/cl-img-1.png" },
